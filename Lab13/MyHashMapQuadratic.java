 ...
 * open addressing with quadratic probing where, initially, 
...
public class MyHashMapQuadratic<K, V> implements MyMap<K, V> {
  ...
  public MyHashMapQuadratic() {  
    this(DEFAULT_INITIAL_CAPACITY, DEFAULT_MAX_LOAD_FACTOR);    
  }
  
  /** Construct a map with the specified initial capacity and 
   * default load factor */
  public MyHashMapQuadratic(int initialCapacity) { 
    this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);    
  }
  
  /** Construct a map with the specified initial capacity 
   * and load factor */
  public MyHashMapQuadratic(int initialCapacity, float loadFactorThreshold) { 
  ...
  public V get(K key) {
    ...
    if (table[bucketIndex] != null) {
      ...
      bucketIndex+=Math.pow(powerForProbe,2);;
