...
public class BSTModified<E> implements Tree<E>,Cloneable{
    ...
    public BSTModified(java.util.Comparator<E> c) {
      this.c = c;
    }

    /** Create a binary tree from an array of objects */
    public BSTModified(E[] objects) {
      this.c = (e1, e2) -> ((Comparable<E>)e1).compareTo(e2);
    ...
    //MODIFIED PART IS BELOW
    
    //getNumberOfLeaves from root
	public int getNumberOfLeaves() {
		return getNumberOfLeaves(root);
	}
	//getNumberOfLeaves from subtree
	...
	//getNumberOfNonLeaves from root
	public int getNumberOfNonLeaves() {
		return getNumberOfNonLeaves(root);
	} 

	//getNumberOfNonLeaves from subtree
	...
	//equals from subtree
	public boolean equals(BSTModified<E> tree) {
	...
	//clone from root only
	public BSTModified<E> clone() throws CloneNotSupportedException {
		BSTModified<E> cloneBST = new BSTModified<>();
		clone(cloneBST, root);
		return cloneBST;
	}

	//clone from subtree and root
	protected void clone(BSTModified<E> clone, TreeNode<E> root) {
		if (root == null) return;
    ...
    public static void main(String[] args) throws Exception { 
    	BSTModified<Integer> tree = new BSTModified<>();
    	tree.add(10);
    	tree.add(3);
    	tree.add(6);
    	tree.add(7);
    	...
    	BSTModified<Integer> tree2 = tree.clone();
